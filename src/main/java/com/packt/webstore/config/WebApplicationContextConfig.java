...
import com.packt.webstore.interceptor.ProcessingTimeLogInterepter;
...
public class WebApplicationContextConfig extends WebMvcConfigurerAdapter{
	...
	@Bean
	public MarshallingView xmMarshallingView() {
	...
	@Bean
	public ViewResolver contentNegotiatingViewResoler(ContentNegotiationManager manager) {
		ContentNegotiatingViewResolver resolver = new ContentNegotiatingViewResolver();
		resolver.setContentNegotiationManager(manager);
		ArrayList<View> views = new ArrayList<View>();
		views.add(jsonView());
		views.add(xmMarshallingView());
	...
	public HandlerInterceptor promoCodeInterceptor() {
		...
		promoCodeInterceptor.setPromoCode("PRO3R");
	...
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addInterceptor(new ProcessingTimeLogInterepter());
